...
# print(runKoG2P('신라', '/home/yeoun/KO_BART/rulebook.txt'))
# print(runKoG2P('실라', '/home/yeoun/KO_BART/rulebook.txt'))
# print(runKoG2P('해돋이', '/home/yeoun/KO_BART/rulebook.txt'))
# print(runKoG2P('해도지', '/home/yeoun/KO_BART/rulebook.txt'))
